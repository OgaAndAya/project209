...
try:
    ...
    def _on_collision(data):
        ...
        Collision_event_record= data.normal.inpulse
        intensity_of_collision= math.sqrt(Collision_event_record.x ** 2 + Collsison_event_record.y ** 2+ Collsison_event_record.z ** 2)
        #print intensity
